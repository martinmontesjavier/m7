...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $objStatement->execute();
                        logMessage("Se ha ACTUALIZADO el usuario con id " . $ID . "\n", 100);
                } else {
                        $strValueList = "";
                        ...
                        logMessage("Se ha INSERTADO un usuario con id " . $ID . "\n", 75);
                }
        }

        public function MarkForDeletion() {
                $this->blForDeletion = true;
                logMessage("Se ha marcado para borrar un usuario \n", 25);
        }
        ...
        public function __destruct() {
                if (isset($this->ID)) {
                        if ($this->blForDeletion == true) {
                                ...
                                $objStatement->execute();
                                logMessage("Se ha BORRADO el usuario con id: " . $this->ID . "\n", 5);
                        };
                }
        }
        ...
        public function __call($strFunction, $arArguments) {
                ...
                switch ($strMethodType) {
                        case "set":
                                logMessage("Se ha creado una función set\n", 75);
                                return($this->SetAccessor
                                      ($strMethodMember, $arArguments[0]));
                                break;
                        case "get":
                                logMessage("Se ha creado una función get\n", 75);
