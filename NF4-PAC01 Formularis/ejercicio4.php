...
if (isset($_POST['botonEnviar'])) { 
    ...
    */
    ...
    VALUES (NOW(), '$nombre', '$descripcion', $valoracion, $movie_id)";
...
$row_number = 0; // Initialize a counter
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // Determine the class based on the row number (odd or even)
...
echo <<<ENDHTML
    ...
    <form style="display:block;" action="ejercicio4.php?movie_id={$_GET['movie_id']}" method="post">
